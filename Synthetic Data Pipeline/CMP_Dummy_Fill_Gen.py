...
def save_label(bboxes, filename):
    ...
    txt_path = f'{OUTPUT_BASE}/CMP/labels/{os.path.splitext(filename)[0]}.txt'
    ...
    with open(txt_path, 'w') as f:
        ...
        for (x, y, w, h) in bboxes:
            ...
            f.write(f"{CMP_CLASS_ID} {(x+w/2)/W:.6f} {(y+h/2)/H:.6f} {w/W:.6f} {h/H:.6f}\n")
...
def generate_coherent_mosaic(idx):
    ...
    cv2.imwrite(f'{OUTPUT_BASE}/CMP/images/{out_name}', final_img)
